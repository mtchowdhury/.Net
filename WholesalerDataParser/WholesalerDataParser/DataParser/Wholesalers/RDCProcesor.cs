        ...
        public List<RDC> ProcessRDC(string path)
        {
            ...
            if (File.Exists(path))
            {
                ...
                foreach (var line in lines)
                {
                    ...
                    // if line lenght 397 remove last 4 element from array Field_Length

                    if (line.Length == 397)
                    {
                        List<int> lst_numbers = new List<int>(Field_Length);
                        lst_numbers.RemoveAt(31);
                        lst_numbers.RemoveAt(31);
                        lst_numbers.RemoveAt(31);
                        lst_numbers.RemoveAt(31);
                        Field_Length = lst_numbers.ToArray();
                    }
                    else if (line.Length == 420)
                    {
                        List<int> lst_numbers = new List<int>(Field_Length);
                        lst_numbers.RemoveAt(31);
                        Field_Length = lst_numbers.ToArray();
                    ...
                    else
                    {
                        if (line.Length != 421)
                        {
                            string ss = line.Length.ToString();
                        }
                    }

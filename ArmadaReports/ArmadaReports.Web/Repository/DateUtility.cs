...
namespace ArmadaReports.Web.Repository
{
    public static class DateUtility
    {
        ...
        public static List<DateTime> GetQuartersBetweenRange(DateTime minDate, DateTime maxDate)
        {
            ...
            {
                if(new DateTime(minDate.Year, 1, 1) <= new DateTime(maxDate.Year, maxDate.Month, 1))
                    dates.Add(new DateTime(minDate.Year, 1, 1));
                if (new DateTime(minDate.Year, 4, 1) <= new DateTime(maxDate.Year, maxDate.Month, 1))
                    dates.Add(new DateTime(minDate.Year, 4, 1));
                if (new DateTime(minDate.Year, 7, 1) <= new DateTime(maxDate.Year, maxDate.Month, 1))
                    dates.Add(new DateTime(minDate.Year, 7, 1));
                if (new DateTime(minDate.Year, 10, 1) <= new DateTime(maxDate.Year, maxDate.Month, 1))

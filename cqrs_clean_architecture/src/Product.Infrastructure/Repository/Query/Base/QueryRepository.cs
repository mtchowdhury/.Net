...
namespace Product.Infrastructure.Repository.Query.Base
{
    ...
    {
        protected QueryRepository(IConfiguration configuration, IOptions<ProductSettings> settings) : base(configuration, settings)
        {
        }
        ...
        //return count of number of rows from a table

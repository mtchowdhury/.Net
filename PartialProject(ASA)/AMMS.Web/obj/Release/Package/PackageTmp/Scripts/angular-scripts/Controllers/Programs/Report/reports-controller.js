ammsAng.controller('reportsController', ['$scope', '$rootScope', 'filterService', '$timeout', 'reportService', 'DTOptionsBuilder', 'DTColumnDefBuilder',
    function ($scope, $rootScope, filterService, $timeout, reportService, DTOptionsBuilder, DTColumnDefBuilder) {
       ...
       // $scope.startDate = new Date(temp.setDate(temp.getDate() - 30));

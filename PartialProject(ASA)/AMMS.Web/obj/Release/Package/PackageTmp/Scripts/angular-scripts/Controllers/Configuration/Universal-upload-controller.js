ammsAng.controller('universalUploadController', [
        ...
        $scope.upload = function () {
            ...
            function (isConfirmed) {
                if (isConfirmed) {
                    $scope.file = $scope.files[$scope.files.length - 1];
                    $scope.uploadStartTime = moment().format();
                    documentService.uploadUniversal($scope.file, $scope.selectedBranchId, $rootScope.workingdate, $scope.file.name).then(function (response) {

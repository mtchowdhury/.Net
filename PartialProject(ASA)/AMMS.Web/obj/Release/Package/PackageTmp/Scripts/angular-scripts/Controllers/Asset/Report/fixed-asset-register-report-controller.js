ammsAng.controller('fixedAssetRegisterReportController', ['$scope', '$rootScope', 'filterService', '$timeout', 'reportService', 'DTOptionsBuilder', 'DTColumnDefBuilder',
    function ($scope, $rootScope, filterService, $timeout, reportService, DTOptionsBuilder, DTColumnDefBuilder) {
       ...
       DTColumnDefBuilder.newColumnDef(4).notSortable()
        ...
        $scope.getFilters = function (reportId) {
            ...
            reportService.getFilters(reportId, $scope.roleId, $scope.employeeId, $scope.branchId, "1975-10-03", "2099-10-03").then(function (response) {
                $scope.filters = angular.copy(response.data);
                $scope.filters[0].Dropdowns = $scope.filters[0].Dropdowns.filter(e => e.Value != "-100000");

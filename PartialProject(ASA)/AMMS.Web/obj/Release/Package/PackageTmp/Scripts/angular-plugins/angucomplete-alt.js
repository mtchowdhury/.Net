  ...
  angular.module('angucomplete-alt', []).directive('angucompleteAlt', ['$q', '$parse', '$http', '$sce', '$timeout', '$templateCache', '$interpolate', function ($q, $parse, $http, $sce, $timeout, $templateCache, $interpolate) {
    ...
    function link(scope, elem, attrs, ctrl) {
      ...
      function getRemoteResults(str) {
        ...
        //if (scope.remoteRequestHeaderFn) {
        //  params.headers = scope.remoteRequestHeaderFn();
          //}
        cancelHttpRequest();
        ...
        httpCallInProgress = true;
          $http({
              method: 'GET',
              url: scope.remoteRequestUrlFormatter(),
              params: scope.remoteUrlRequestFormatter(str),
              headers: scope.remoteRequestHeaderFormatter()
              })
    ...
    return {
      ...
      scope: {
        ...
        focusFirst: '@',
        parseInput: '&',
        remoteRequestHeaderFormatter: '=',
        remoteRequestUrlFormatter: '='
      },

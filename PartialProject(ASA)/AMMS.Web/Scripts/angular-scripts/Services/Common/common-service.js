ammsAng.service('commonService', ['$http', '$timeout', '$rootScope', function ($http, $timeout, $rootScope) {
    ...
    this.getExportUrlForCashAndBankStatus = function (url, filterparams, fileName) {
        console.log($rootScope.user);
        return $rootScope.reportApiUrl + 'report/exportdatalistForCashAndBankStatus?url=' + Encrypt.encrypt(url) + '&filterparams=' + Encrypt.encrypt(filterparams) +
            '&fileName=' + Encrypt.encrypt(fileName) + '&apiKey=' + Encrypt.encrypt($rootScope.user.SecretKey) + '&user=' + Encrypt.encrypt($rootScope.user.UserId);
    }
    this.getExportUrlForFundTransferReceive = function (url, filterparams, fileName) {
        console.log($rootScope.user);
        return $rootScope.reportApiUrl + 'report/exportdatalistForFundTransferReceive?url=' + Encrypt.encrypt(url) + '&filterparams=' + Encrypt.encrypt(filterparams) +
            '&fileName=' + Encrypt.encrypt(fileName) + '&apiKey=' + Encrypt.encrypt($rootScope.user.SecretKey) + '&user=' + Encrypt.encrypt($rootScope.user.UserId);
    }
    this.getExportUrlForCashBook = function (url, filterparams, fileName) {
        console.log($rootScope.user);
        return $rootScope.reportApiUrl + 'report/exportdatalistForCashBook?url=' + Encrypt.encrypt(url) + '&filterparams=' + Encrypt.encrypt(filterparams) +
            '&fileName=' + Encrypt.encrypt(fileName) + '&apiKey=' + Encrypt.encrypt($rootScope.user.SecretKey) + '&user=' + Encrypt.encrypt($rootScope.user.UserId);
    }

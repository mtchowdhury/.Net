ammsAng.service('memberService', ['$rootScope', '$http', function ($rootScope, $http) {
    ...
    this.getMembersOfGroupByGroupId = function (groupId,branchId) {
        return $http({
            method: 'GET',
    ...
    this.changeGroupTypeOfMember = function (memberId, newGroupId, workingDate) {
        return $http({
            method: 'GET',
            ...
            params: {
                ...
                startdate: Encrypt.encrypt(workingDate)
            }
        });
    }
    ...
    this.getMembersOfGroupFromSp = function (branchId,groupId) {
        return $http({
            method: 'GET',
            url: $rootScope.programsApiBaseUrl + 'member/member/getMemberListByGroup',
            params: {
                branchId: Encrypt.encrypt(branchId),
                groupId: Encrypt.encrypt(groupId)
            },

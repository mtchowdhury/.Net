ammsAng.service('loanaccountService', [
    '$http', '$rootScope', function ($http, $rootScope) {
        ...
        this.getSupplimentaryAvailability = function (memberId, productId, branchId) {
            return $http({
                method: 'GET',
        ...
        this.getLoanAccount = function (accountId, branchId) {
            return $http({
                method: 'GET',
        ...
        this.deleteLoanAccount = function (accountId, branchId) {
            return $http({
                method: 'DELETE',
        ...
        this.GetAllowanceAmount = function (memberId, deathDate, closeDate, accountId, branchId) {
            return $http({
                method: 'GET',
        ...
        this.getLoanAccountsFromSP = function (branchId, memberId) {
            return $http({
                method: 'GET',
                url: $rootScope.programsApiBaseUrl + 'account/loan/loanAccountsOfmemberFromSP',
                params: {
                    branchId: Encrypt.encrypt(branchId),
                    memberId: Encrypt.encrypt(memberId)
                },

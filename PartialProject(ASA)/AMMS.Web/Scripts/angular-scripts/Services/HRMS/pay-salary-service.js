ammsAng.service('paySalaryService', [
    '$http', '$rootScope', function ($http, $rootScope) {
        ...
        this.getEmployeeFirstSalaryStructureStartDate = function (employeeId) {
            return $http({
                method: 'GET',
                url: $rootScope.hrmsApiBaseUrl + 'employeePaySalary/getEmployeeFirstSalaryStructureStartDate',
                params: {
                    employeeId: Encrypt.encrypt(employeeId)
                },

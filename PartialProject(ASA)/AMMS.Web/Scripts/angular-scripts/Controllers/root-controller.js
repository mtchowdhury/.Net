ammsAng.controller('rootController', ['$scope', '$rootScope', '$translate', '$timeout', 'commonService', function ($scope, $rootScope, $translate, $timeout, commonService) {
    ...
    $rootScope.isItReallyTime = true;

    $rootScope.addConfirmation = ' ### will be added, are you sure? ';
    $rootScope.deleteConfirmation = ' ### will be delete, are you sure? ';
    ...
    $rootScope.env = "dev";//release e change hobe
      ...
      $rootScope.enableAsifBetaCode = false;//its fixed for you tawhid. // no its not fixed now i have to fix employee default branch ! >:(
    if ($rootScope.env === "dev") {
        ...
        $rootScope.onlineToTabdataApiBaseUrl = 'http://localhost:8437/';
        ...
        $rootScope.accountsApiBaseUrl = 'http://192.168.0.30/ammstr-accounts-service/accounts/';
        $rootScope.commonApiBaseUrl = 'http://192.168.0.30/ammstr-common-service/common/';
        $rootScope.hrmsApiBaseUrl = 'http://192.168.0.30/ammstr-hrms-service/hrms/';
        $rootScope.masterdataApiBaseUrl = 'http://192.168.0.30/ammstr-masterdata-service/masterdata/';
        $rootScope.programsApiBaseUrl = 'http://192.168.0.30/ammstr-program-service/programs/';
        $rootScope.assetApiBaseUrl = 'http://192.168.0.30/ammstr-asset-service/asset/';
        $rootScope.inventoryApiBaseUrl = 'http://192.168.0.30/ammstr-inventory-service/';
        $rootScope.commonDownloadUrl = 'http://192.168.0.30/ammstr-common-service/';
        $rootScope.assetApiUrl = 'http://192.168.0.30/ammstr-asset-service/asset/';
        $rootScope.reportApiUrl = 'http://192.168.0.30/ammstr-reports-service/reports/';
        $rootScope.inventoryApiBaseUrl = 'http://192.168.0.30/ammstr-inventory-service/inventory/';
        $rootScope.locationStr = "/ammstr-web";
    } else if ($rootScope.env === "test") {
        console.log = function () { }
        $rootScope.accountsApiBaseUrl = 'http://192.168.0.30/amms-accounts-service/accounts/';
        $rootScope.commonApiBaseUrl = 'http://192.168.0.30/amms-common-service/common/';
        $rootScope.hrmsApiBaseUrl = 'http://192.168.0.30/amms-hrms-service/hrms/';
        $rootScope.masterdataApiBaseUrl = 'http://192.168.0.30/amms-masterdata-service/masterdata/';
        $rootScope.programsApiBaseUrl = 'http://192.168.0.30/amms-program-service/programs/';
        $rootScope.assetApiBaseUrl = 'http://192.168.0.30/amms-asset-service/asset/';
        $rootScope.inventoryApiBaseUrl = 'http://192.168.0.30/amms-inventory-service/inventory/';
        $rootScope.commonDownloadUrl = 'http://192.168.0.30/amms-common-service/';
        $rootScope.assetApiUrl = 'http://192.168.0.30/amms-asset-service/asset/';
        $rootScope.reportApiUrl = 'http://192.168.0.30/amms-reports-service/reports/';
        $rootScope.locationStr = "/amms-web";
    } else if ($rootScope.env === "stg") {
        console.log = function () { }
        $rootScope.commonApiBaseUrl = 'http://upload.asabd.org/amms-common-service/common/';
        $rootScope.hrmsApiBaseUrl = 'http://upload.asabd.org/amms-hrms-service/hrms/';
        $rootScope.masterdataApiBaseUrl = 'http://upload.asabd.org/amms-masterdata-service/masterdata/';
        $rootScope.programsApiBaseUrl = 'http://upload.asabd.org/amms-program-service/programs/';
        $rootScope.assetApiBaseUrl = 'http://upload.asabd.org/ammsdemo-asset-service/asset/';
        $rootScope.inventoryApiBaseUrl = 'http://upload.asabd.org/amms-inventory-service/inventory/';
        $rootScope.commonDownloadUrl = 'http://upload.asabd.org/amms-common-service/';
        $rootScope.assetApiUrl = 'http://upload.asabd.org/amms-asset-service/asset/';
        $rootScope.reportApiUrl = 'http://upload.asabd.org/amms-reports-service/reports/';
        $rootScope.locationStr = "/amms-web";
    ...
    $rootScope.FeeConfig = {
        ...
        Status: { Active: { text: "Active", value: 1 }, Inactive: { text: "Inactive", value: 0 } }
    };
    $rootScope.AccountType = { Loan: 1, GeneralSavings: 2, CBS: 3, LTS: 4 };
    $rootScope.ProductType = { Loan: 1, Savings: 2 };
    $rootScope.LoanStatus = { Active: 1, Inactive: 0 };
    $rootScope.LoanAccountStatus = { Active: "1", Close: "0" };
    ...
    $rootScope.LoanConfig = {
        ...
        LoanAccountStatus: { Active: "1", Close: "0", DELETED: "-1" },
        BadDebtAccountStatus: { Disbursed: 1, Closed: 0 },
    ...
    $rootScope.SavingsConfig = {
        SavingsAccountStatus: { Pending: 2, Active: 1, Closed: 0, Deleted: -1 },
        ...
        SavingProductStatus: { Active: 1, Pending: 3, Inactive: 0 },
        SavingsType: {
            General: 2,
            LTS: 4,
            CBS: 3
    ...
    Resolve:11,
    EmployeeMedical:12,
    EmployeeFamilyMedical:13,
    EmployeeAccident:14,
    Subsidy:15,
    EmployerContribution:16
    }
    ...
    $rootScope.AssetConfig = {
        AssetStatus: { Active: 1, Inactive: 0, Deleted: -1 },
        ...
        ItemTypeStatus: { Active: 1, Inactive: 0, Deleted: -1 },
        CategoryStatus: { Active: 1, Inactive: 0, Deleted: -1 },
        AssetType: { IT: 1, NonIT: 0 },
        SupplierStatus: { Active: 1, Inactive: 0, Deleted: -1 },
    ...
    $rootScope.transactionSummaryReportConfig = {
        ReportType: { SummaryReport: 1, LoanCollection: 2, LoanDisbursedAndFullPaid: 3, SavingsCbsCollection: 4, SavingsCbsWithdrawal: 5 }
    }

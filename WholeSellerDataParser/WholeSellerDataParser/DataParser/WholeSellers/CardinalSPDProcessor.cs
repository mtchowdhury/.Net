                ...
                using (var package = new ExcelPackage(file))
                {
                    ...
                    for (var row = 2; row <= rowCount; row++)
                    {
                       ...
                       var FILLER1 = worksheet.Cells[row, 1].Value;
                        ...
                        COST_TOT = COST_TOT != null ?double.Parse(COST_TOT.ToString().Trim())  : 0.00,
                        ...
                        SHIP_QTY= SHIP_QTY != null ?Int32.Parse(SHIP_QTY.ToString().Trim())   : 0,
                        ...
                        TOT_COST= TOT_COST != null ?double.Parse(TOT_COST.ToString().Trim()) : 0.0,
